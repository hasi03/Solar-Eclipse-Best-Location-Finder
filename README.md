...
In addition to locating the best place, you need to find the best places mostly recommended by locals, to travel to in the area. You can automatically get a list of places by running **Local_Spots** library. It web scrape the posts and comments related to the place on reddit and then run a pretrained **Named Entity Recognition (NER)** model (**bert-base-NER**) to extract the names of the locations. 
...
The best location for the Solar Eclipse 2024. 
<figure>
